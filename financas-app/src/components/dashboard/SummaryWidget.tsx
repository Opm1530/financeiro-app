...
import { TrendingUp, TrendingDown, DollarSign, Contact, Repeat } from 'lucide-react';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                ...
                <Card style={{ padding: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                        ...
                        <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Recorrencia</span>
                    </div>
                    <div style={{ fontSize: '1.125rem', fontWeight: 600, color: 'var(--color-text-primary)' }}>
                        {formatCurrency(financials.totalRecurrence)}
                    </div>
                </Card>
                <Card style={{ padding: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                        <Contact size={16} color="var(--color-warning)" />
                        <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Contratos Ativos</span>
                    </div>
                    <div style={{ fontSize: '1.125rem', fontWeight: 600, color: 'var(--color-text-primary)' }}>
                        {financials.calculateActiveContracts}
                    </div>
                </Card>
            </div>
        </section>
